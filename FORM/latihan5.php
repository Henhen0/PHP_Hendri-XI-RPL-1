...
<html lang="en">
  ...
  <body>
    <form action="validasiL5.php" class="bg-white" method="post">
    <center>
    ...
    <td class="pe-5">
        BPJS <br> <input type="number" name="bpjs" required> <br> Pinjaman <br> <input type="number" name="pinjaman" placeholder="Pinjaman" required> <br> Cicilan <br> <input type="number" name="tabungan" placeholder="Tabungan" required><br>
        Infaq <br> <input name="lainnya" type="number" placeholder="Lainnya" required> <br><br> <input type="submit" class="btn btn-primary" name="proses" value="Proses">
    </td>
     </tr>
